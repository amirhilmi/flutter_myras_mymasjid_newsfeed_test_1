...
class ChartMain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'MyMasjid Dashboard'),
    );
  }
}
      ...
      body:Container(
        ...
        children: <Widget>[
          Padding(
            ...
            child: mychart1Items("Income by Month","421.3M","+12.9% of target"),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: myCircularItems("Income Source","68.7M"),
          ),
          Padding(
            padding: const EdgeInsets.only(right:8.0),
            child: myTextItems("Expense","48.6M"),
          ),
          Padding(
            padding: const EdgeInsets.only(right:8.0),
            child: myTextItems("Jamaah","25.5M"),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
